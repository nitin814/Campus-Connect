export const getIncomingCallDialog = (
    ...
    title.innerHTML = `Incoming ${callType} Call from ${username}`;
  
    const imageContainer = document.createElement("div");
    imageContainer.classList.add("dialog_image_container");
    const image = document.createElement("img");
    const avatarImagePath = "/images/dialogAvatar.png";
    ...
    const acceptCallImgPath = "/images/AcceptCall.jpg";
    ...
    const rejectCallImgPath = "/images/RejectCall.jpg";
  ...
  export const getCallingDialog = (calleePersonalCode , rejectCallHandler) => {
    const dialog = document.createElement("div");
    dialog.classList.add("dialog_wrapper");
    const dialogContent = document.createElement("div");
    dialogContent.classList.add("dialog_content");
    ...
    const title = document.createElement("p");
    title.classList.add("dialog_title");
    title.innerHTML = `Calling ${calleePersonalCode}`;
...
export const getLeftMessage = (message) => {  
    ...
    const messaageParagraph = document.createElement("p");
    messaageParagraph.classList.add("message_left_paragraph");
    messaageParagraph.innerHTML = message;
    messageContainer.appendChild(messaageParagraph);
...
export const getRightMessage = (message) => {
    ...
    const messaageParagraph = document.createElement("p");
    messaageParagraph.classList.add("message_right_paragraph");
    messaageParagraph.innerHTML = message;
    messageContainer.appendChild(messaageParagraph);
    return messageContainer;
  };